...
This page is created to demonstrate the results of an ongoing project in path smoothing and optimization.
...
## How it is done: 
It is a post-processing algorithm that works on an initial path generated by the RRT algorithm using Dubins Curves for the extend/steer function. 
...
The below illustration shows how the post-processing function optimizes the initial loopy and sub-par path and generates a much smoother and shorter path.
